# Stellar Kit - Getting Started Guide

## Introduction
Welcome to Stellar Kit (prev. Stellar Suite)! This guide will help you install, configure, and begin using the Stellar Kit extension. The extension improves the developer experience when building smart contracts on Stellar, allowing you to build, deploy, and manage contracts directly from your editor.
...
3. Search for "Stellar Kit" in the Extensions view search bar.
4. Click on the **Install** button next to the Stellar Kit extension.
5. Once installed, the Stellar Kit icon will appear in the Activity Bar.
...
## Basic Configuration
After installation, you can configure Stellar Kit to match your development environment.

1. Open VS Code Settings (`Ctrl+,` or `Cmd+,`).
2. Search for "Stellar Kit" (settings are under the Stellar Kit section).
...
### 1. Build a Contract
From the Stellar Kit view in the Activity Bar:
...
- Right-click on a contract in the Stellar Kit view.
...
![Stellar Kit Sidebar](https://raw.githubusercontent.com/0xVida/stellar-suite/main/resources/stellar-icon.png)
...
- **CLI Version Mismatch**: Ensure your `stellar` CLI version matches the minimum required version (`21.0.0`). You can use the **Stellar Kit: Check CLI Version** command to verify.
...
- **Missing CLI Path**: If the extension cannot find the Stellar CLI, provide the absolute path in the Stellar Kit CLI Path extension setting.

## Additional Resources
- [Stellar Developer Documentation](https://developers.stellar.org/)
- [Stellar Smart Contracts (Soroban)](https://soroban.stellar.org/)
- [Stellar Kit GitHub Repository](https://github.com/0xVida/stellar-suite) (repo name: stellar-suite)
